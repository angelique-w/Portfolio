...
let arrayProjects = [
    ...
    },
    {
        ...
        description: "Création en cours d'un réseau social pour Antic Pays-Basque.",
        descriptionModal: "Les enfants de moins de 13 ans sont massivement présents sur les réseaux sociaux. Or tous les parents ne sont pas en mesure de les accompagner dans l’apprentissage des codes sociaux numériques. Le projet RESOLAB vise donc à prévenir les comportements à risque des adolescents sur les Réseaux Sociaux en adaptant au monde « numérique », les espaces d’expérimentation qui existent dans le monde « physique ». (cf. <a href='https://www.antic-paysbasque.com/projets/resolab/'>Site Antic Pays-Basque</a>)</br>Ainsi, notre client nous demande de créer une plateforme reprenant les codes des réseaux sociaux actuels. Il s'agira d'un premier prototype leur permettant d'expérimenter le dispositif au sein d'écoles patenaires.</br>Une authentification est mise en place, l'utilisateur est identifié en tant qu'écolier ou modérateur, impliquant des possibilités d'actions différentes sur la plateforme. Les utilisateurs peuvent poster des publications, liker, commenter et intéragir entre-eux via un système de discussion instantanée.",
        url:"",
        techno: "React - Material UI - Node.js - Express - Redux",
        isProjectIndividial: false
    },
    {
        id: "card6",
